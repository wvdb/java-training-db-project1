 ...
 */
public class MyApplicationMySQL {
    private static final Logger LOGGER = LogManager.getLogger(MyApplicationMySQL.class);
...
//        }
    ...
    public static void main(String args[]) throws InterruptedException, FileNotFoundException {
        ...
        switch (oefeningInteger) {
            case 1:
                MyApplicationMySQL.oefeningSqlite();
                break;
            case 2:
                MyApplicationMySQL.oefeningBeers2();
                break;
            case 3:
                MyApplicationMySQL.oefeningBeers3();
                break;
            case 6:
                MyApplicationMySQL.oefeningBeers6();
                break;
            case 7:
                MyApplicationMySQL.oefeningTransactions7();
                break;
            case 8:
                MyApplicationMySQL.oefeningBeers8();
                break;
            case 11:
                MyApplicationMySQL myApplicationMySQL = new MyApplicationMySQL();
                myApplicationMySQL.oefeningBeers11();
                break;
            case 99:
                MyApplicationMySQL.oefeningStoredProc99();
                break;
            default:
